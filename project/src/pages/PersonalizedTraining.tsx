...
const PersonalizedTraining: React.FC = () => {
  ...
  return (
    <div className="p-8 bg-zinc-900/50 rounded-2xl max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <button onClick={() => setActiveTab("ask")} className={`px-6 py-3 ${activeTab === "ask" ? "text-white bg-purple-600" : "text-gray-400"}`}>Ask AI</button>
        <button onClick={() => setActiveTab("history")} className={`px-6 py-3 ${activeTab === "history" ? "text-white bg-purple-600" : "text-gray-400"}`}>History</button>
        <button onClick={() => setActiveTab("saved")} className={`px-6 py-3 ${activeTab === "saved" ? "text-white bg-purple-600" : "text-gray-400"}`}>Saved</button>
      </div>
